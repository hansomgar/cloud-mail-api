...
const requirePerms = [
	...
	'/admin/account-archives/list',
	'/admin/account-archives/delete',
	'/my/delete',
	'/analysis/echarts',
	'/role/add',
	'/role/list',
...
const premKey = {
	...
	'account:add': ['/account/add', '/account/setEmail'],
	'account:query': ['/account/list', '/account/setName', '/account/archive/list'],
	'account:delete': ['/account/delete', '/account/archive/delete'],
	'my:delete': ['/my/delete'],
	'role:add': ['/role/add'],
	...
	'all-email:query': ['/allEmail/list','/allEmail/latest','/admin/account-archives/list'],
	'all-email:delete': ['/allEmail/delete','/allEmail/batchDelete','/admin/account-archives/delete'],
