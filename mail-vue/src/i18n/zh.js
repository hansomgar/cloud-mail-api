const zh = {
    ...
    userEmail: '用户邮箱',
    restApi: 'REST API',
    restApiAccess: '用户 REST API',
    restApiAccessDesc: '开启后，用户可以创建 API Key，并通过 HTTP 请求操作自己的邮箱、邮件和附件数据',
    restApiDisabledDesc: '管理员当前未开放 REST API，已有 Key 暂时不可使用',
    apiKeys: 'API Key',
    apiKeyName: 'Key 名称',
    ...
    revokeApiKey: '吊销',
    revokeApiKeyConfirm: '确定吊销这个 API Key 吗？使用它的程序将立即无法访问。',
    apiKeyPrefix: 'Key 前缀',
